...
<body>
	<header class="adminTopbar">
		<div id="testLoader"  >
			<div class="appLoader" class="hide">
			<img style="width:25px;height:25px;display:block;" src="<?php echo WEBROOT.'img/loader.gif';?>" alt="">
			</div>
		</div>
	...
	<div class="leftBar">
		...
		<nav class="adminMainMenu">
			<ul>
				...
				<li><a class="toggleBt" href="<?php echo ADMINROOT.'/webeditor/';?>">Editor</a>
					<ul class="toggleMenus editorList">
						<li><a href="<?php echo ADMINROOT.'/pages/';?>">file index</a></li>
						<?php 
							echo $editorDir;
 ?>
					</ul>
				...
				<li><a href="<?php echo ADMINROOT.'/newsletter/';?>"><span class="goldBookIcon icon"></span>News Letter</a></li>
				<li><a href="<?php echo ADMINROOT.'/guestbook/';?>"><span class="goldBookIcon icon"></span>Guest book</a></li>
		...
		<div class="copyright">
			© <a href="mailto:franckywebdesign@gmail.com">Francky</a>
		</div>
	</div>
	<div class="appCore">
	...
	<script src="<?php echo WEBROOT.'view/template/admin_panel_by_francky_bofrancky_v0/js/app.js';?>"></script>
</body>
</html>	